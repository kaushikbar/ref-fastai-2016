...
class Vgg16():
    ...
    def fit(self, batches, val_batches, epochs=1):
        """
            ...
            See Keras documentation: https://keras.io/models/model/
        """
        self.model.fit_generator(batches, samples_per_epoch=batches.samples, epochs=epochs,
                validation_data=val_batches, nb_val_samples=val_batches.samples)
        return(batches.samples, val_batches.samples)
    ...
    def test(self, path, batch_size=8):
        ...
        return test_batches, self.model.predict_generator(test_batches, math.ceil(test_batches.samples/test_batches.batch_size))
